...
const LOCATION_KEYWORDS = [
  ...
  'sholavaram', 'minjur', 'thiruvottiyur', 'sowcarpet', 'royapuram', 'fishermen colony',
  'marina beach', 'elliot beach', 'besant nagar beach', 'covelong beach', 'muttukadu backwaters',
  'chennai central station', 'chennai egmore station', 'chennai beach station',
  'chennai airport', 'chennai port', 'chennai trade center',  'chennai corporation office', 'chennai metro station', 'chennai bus stand', 'chennai railway station', 'chennai marina', 'chennai velachery', 'chennai tambaram', 'chennai adyar', 'chennai pallavaram', 'chennai mylapore', 'chennai guindy', 'chennai porur', 'chennai nanganallur', 'chennai meenambakkam',
  'chennai chrompet', 'chennai ambattur', 'chennai nungambakkam', 'chennai besant nagar', 'chennai sholinganallur',
  'chennai perungudi', 'chennai triplicane', 'chennai egmore', 'chennai kodambakkam', 'chennai kk nagar', 'chennai alandur',
